...
public class Composition {
	public static void main(String[] args) {
		...
		// Deleting order would also delete associated LineItems ------- Represents
		// Composition relationship between Order and LineItem
		o = null;
		// Line items are deleted, but associated products can still exist --------
		// Represents Aggregation relationship between LineItem and Product
...
/**
 * This is LineItem class, which HAS-A aggregation association with Product
 * class. That means, if you delete LineItem, then associated Product can exist.
 * 
 * @author tirthalp
 * 
 */
